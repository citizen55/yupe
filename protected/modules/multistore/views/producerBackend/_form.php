        ...
        <div class="panel-heading">
            <div class="panel-title">
                <a data-toggle="collapse" data-parent="#extended-options" href="#collapseOne">
                    <?php echo Yii::t('MultistoreModule.multistore', 'Data for SEO'); ?>
                </a>
            </div>
        </div>
...
<?php $this->widget(
    ...
    [
        'buttonType' => 'submit',
        'context'    => 'primary',
        'label'      => $model->getIsNewRecord() ? Yii::t('MultistoreModule.producer', 'Add producer and continue') : Yii::t('MultistoreModule.producer', 'Save producer and continue'),
    ]
); ?>
...
<?php $this->widget(
    ...
    [
        ...
        'label'       => $model->getIsNewRecord() ? Yii::t('MultistoreModule.producer', 'Add producer and close') : Yii::t('MultistoreModule.producer', 'Save producer and close'),
    ]
); ?>
