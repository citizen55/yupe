<?php
$this->breadcrumbs = [
    Yii::t('MultistoreModule.category', 'Categories') => ['index'],
    $model->name,
];

$this->pageTitle = Yii::t('MultistoreModule.category', 'Categories - view');
...
<div class="page-header">
    <h1>
        <?php echo Yii::t('MultistoreModule.category', 'Viewing category'); ?><br/>
