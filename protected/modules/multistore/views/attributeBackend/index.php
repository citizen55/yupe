...
$this->pageTitle = Yii::t('MultistoreModule.attr', 'Attributes - manage');
...
<div class="page-header">
    <h1>
        <?php echo Yii::t('MultistoreModule.attr', 'Attributes'); ?>
...
<div class="row">
    <div class="col-sm-3">
        <fieldset>
            <legend><?php echo Yii::t("MultistoreModule.attr", "Attribute groups"); ?></legend>
            <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    $container.on('click', '#add-attribute-group', function (e) {
                        e.preventDefault();
                        var name = prompt('<?php echo Yii::t("MultistoreModule.multistore", "Title"); ?>');
                        if (name) {
                            var data = {name: name};
                            data["<?php echo Yii::app()->getRequest()->csrfTokenName?>"] = "<?php echo Yii::app()->getRequest()->csrfToken?>";
                            $.ajax({
                                url: '<?php echo Yii::app()->createUrl("/multistore/attributeBackend/groupCreate")?>',
                                type: 'post',
                                data: data,
                                dataType: 'json',
        ...
        $this->widget(
            ...
            [
                ...
                'sortableAction' => '/multistore/attributeBackend/sortable',
                'actionsButtons' => [
                    'clear' => CHtml::link(
                        Yii::t("MultistoreModule.multistore", "Without a group"),
                        '#',
                ...
                'columns' => [
                    [
                        ...
                        'editable' => [
                            'type' => 'text',
                            'url' => ['/multistore/attributeBackend/inlineEditGroup'],
                            'title' => Yii::t('MultistoreModule.multistore', 'Enter {field}', ['{field}' => mb_strtolower($attributeGroup->getAttributeLabel('name'))]),
                            'params' => [
            ...
            [
                ...
                'columns' => [
                    ...
                    [
                        'name' => 'name',
                        'type' => 'raw',
                        'value' => 'CHtml::link($data->name, array("/multistore/attributeBackend/update", "id" => $data->id))',
                    ],
                    [
                        'name' => 'title',
                        'type' => 'raw',
                        'value' => 'CHtml::link($data->title, array("/multistore/attributeBackend/update", "id" => $data->id))',
                    ],
                    [
                        'name' => 'type',
                        'type' => 'text',
