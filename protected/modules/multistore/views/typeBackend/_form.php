...
<div class='row'>
    <div class="col-sm-7 form-group">
        ...
        <?php $this->widget('multistore.widgets.CategoryTreeWidget', ['selectedCategories' => unserialize($model->categories), 'id' => 'category-tree']); ?>
    </div>
</div>
    ...
    <div class="col-sm-7">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo Yii::t("MultistoreModule.type", "Type attributes"); ?>
            </div>
...
<?php $this->widget(
    ...
    [
        'buttonType' => 'submit',
        'context' => 'primary',
        'label' => $model->getIsNewRecord() ? Yii::t('MultistoreModule.type', 'Add type and continue') : Yii::t('MultistoreModule.type', 'Save type and continue'),
    ]
); ?>
...
<?php $this->widget(
    ...
    [
        ...
        'label' => $model->getIsNewRecord() ? Yii::t('MultistoreModule.type', 'Add type and close') : Yii::t('MultistoreModule.type', 'Save type and close'),
    ]
); ?>
