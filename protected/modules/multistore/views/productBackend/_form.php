 ...
 */
?>
<?php Yii::app()->getClientScript()->registerCssFile($this->getModule()->getAssetsUrl() . '/css/multistore-backend.css'); ?>

<ul class="nav nav-tabs">
    <li class="active"><a href="#common" data-toggle="tab"><?= Yii::t("MultistoreModule.multistore", "Common"); ?></a></li>
    <li><a href="#attributes" data-toggle="tab"><?= Yii::t("MultistoreModule.attr", "Attributes"); ?></a></li>
    <li><a href="#images" data-toggle="tab"><?= Yii::t("MultistoreModule.multistore", "Images"); ?></a></li>
    <li><a href="#variants" data-toggle="tab"><?= Yii::t("MultistoreModule.multistore", "Variants"); ?></a></li>
    <li><a href="#stock" data-toggle="tab"><?= Yii::t("MultistoreModule.multistore", "Stock"); ?></a></li>
    <li><a href="#seo" data-toggle="tab"><?= Yii::t("MultistoreModule.multistore", "SEO"); ?></a></li>
    <li><a href="#linked" data-toggle="tab"><?= Yii::t("MultistoreModule.multistore", "Linked products"); ?></a></li>
</ul>
...
<div class="alert alert-info">
    <?= Yii::t('MultistoreModule.multistore', 'Fields with'); ?>
    <span class="required">*</span>
    <?= Yii::t('MultistoreModule.multistore', 'are required'); ?>
</div>
...
<div class="tab-content">
		...
		<div class="row">
			<div class="col-sm-6">
                <?= $form->dropDownListGroup(
                    ...
                    [
                        'widgetOptions' => [
                            'data' => CHtml::listData(Org::model()->findAll(), 'id', 'name'), // TypeOrg::model()->getFormattedList(),
                            'htmlOptions' => [
                                'empty' => '---',
                            ],
                        ],
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <?= $form->dropDownListGroup(
                    ...
                    [
                        'widgetOptions' => [
                            'data' => MultistoreCategory::model()->getFormattedList(),
                            'htmlOptions' => [
                                'empty' => '---',
                                'encode' => false,
                            ],
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a class="panel-title collapsed" data-toggle="collapse" data-parent="#accordion_price" href="#collapse_price">
                                <?= Yii::t("MultistoreModule.multistore", 'Additional price'); ?>
                            </a>
                        </div>
        ...
        <div class='row'>
            <div class="col-sm-7">
                <div class="form-group">
                    <?= CHtml::label(
                        Yii::t("MultistoreModule.category", 'Additional categories'),
                        null,
                        ['class' => 'control-label']
                    ); ?>
                    <?php $this->widget(
                        'multistore.widgets.CategoryTreeWidget',
                        [
    ...
    <div class="tab-pane" id="images">
        <div class="row form-group">
            <div class="col-sm-2">
                <?= Yii::t("MultistoreModule.multistore", "Images"); ?>
            </div>
            <div class="col-sm-2">
        ...
        <div class="row">
            ...
            <div id="product-images">
                <div class="image-template hidden form-group">
                    <div class="row">
                        <div class="col-sm-3">
                            <label for=""><?= Yii::t("MultistoreModule.multistore", "File"); ?></label>
                            <input type="file" class="image-file"/>
                        </div>
                        <div class="col-sm-2">
                            <label for=""><?= Yii::t("MultistoreModule.multistore", "Title"); ?></label>
                    ...
                    <div class="product-image">
                        ...
                        <div>
                            <a data-id="<?= $image->id; ?>" href="<?= Yii::app()->createUrl(
                                '/multistore/productBackend/deleteImage',
                                ['id' => $image->id]
    ...
    <div class="tab-pane" id="variants">
        <div class="row">
            <div class="col-sm-12 form-group">
                <label class="control-label" for=""><?= Yii::t("MultistoreModule.attr", "Attribute"); ?></label>
                ...
                <div class="col-sm-12">
                    <div class="variant-template variant form-inline">
                        <table>
                            <thead>
                                <tr>
                                    <td><?= Yii::t("MultistoreModule.attr", "Attribute"); ?></td>
                                    <td><?= Yii::t("MultistoreModule.multistore", "Value"); ?></td>
                                    <td><?= Yii::t("MultistoreModule.multistore", "Price type"); ?></td>
                                    <td><?= Yii::t("MultistoreModule.multistore", "Price"); ?></td>
                                    <td><?= Yii::t("MultistoreModule.multistore", "SKU"); ?></td>
                                    <td><?= Yii::t("MultistoreModule.multistore", "Order"); ?></td>
                                    <td></td>
                                </tr>
                            </thead>
    ...
    <div class="tab-pane" id="linked">
        <?php if ($model->getIsNewRecord()): ?>
            <?= Yii::t("MultistoreModule.multistore", "First you need to save the product."); ?>
        <?php else: ?>
...
<?php $this->widget(
    ...
    [
        'buttonType' => 'submit',
        'context' => 'primary',
        'label' => $model->getIsNewRecord() ? Yii::t('MultistoreModule.multistore', 'Add product and continue') : Yii::t(
            'MultistoreModule.multistore',
...
<?php $this->widget(
    ...
    [
        ...
        'label' => $model->getIsNewRecord() ? Yii::t('MultistoreModule.multistore', 'Add product and close') : Yii::t(
            'MultistoreModule.multistore',
...
<script type="text/javascript">
    $(function () {
        ...
        function updateVariantTypeAttributes() {
            ...
            if (typeId) {
                $.getJSON('<?= Yii::app()->createUrl('/multistore/productBackend/typeAttributes');?>/' + typeId, function (data) {
                    typeAttributes = data;
        ...
        $("#add-product-variant").click(function (e) {
            ...
            $.get('<?= Yii::app()->createUrl('/multistore/productBackend/variantRow');?>/' + attributeId, function (data) {
                tbody.append(data);
            });
        });
        ...
        $('#product-type').on('change',function () {
            var typeId = $(this).val();
            if (typeId) {
                $('#attributes-panel').load('<?= Yii::app()->createUrl('/multistore/productBackend/typeAttributesForm');?>/' + typeId);
                updateVariantTypeAttributes();
            }
            else {
        ...
        $('.product-delete-image').on('click', function (event) {
            ...
            $.ajax({
                ...
                url: '<?= Yii::app()->createUrl('/multistore/productBackend/deleteImage');?>',
                success: function () {
