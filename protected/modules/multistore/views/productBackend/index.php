...
$this->pageTitle = Yii::t('MultistoreModule.multistore', 'Products - manage');
?>
...
<?php $this->widget(
    ...
    [
        ...
        'sortableAction'    => '/multistore/productBackend/sortable',
        'type' => 'condensed',
        ...
        'actionsButtons' => [
            'add' => CHtml::link(
                ...
                ['/multistore/productBackend/create'],
                ['class' => 'btn btn-sm btn-success pull-right']
            ),
            'copy' => CHtml::link(
                Yii::t('MultistoreModule.multistore', 'Copy'),
                '#',
        ...
        'columns' => [
            ...
            [
                ...
                'type' => 'raw',
                'filter' => CHtml::activeDropDownList($model, 'category', MultistoreCategory::model()->getFormattedList(), ['encode' => false, 'empty' => '', 'class' => 'form-control']),
...
<?php
$url = Yii::app()->createUrl('/multistore/productBackend/copy');
