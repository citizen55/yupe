            ...
            <?php if (is_array($type->typeAttributes)): ?>
                ...
                foreach ($type->typeAttributes as $attribute) {
                    if ($attribute->group) {
                        ...
                        $attributeGroups[Yii::t('MultistoreModule.attribute', 'Without a group')][] = $attribute;
                    }
                }
                ?>
...
<?php else: ?>
    <div class="alert alert-info">
        <?= Yii::t('MultistoreModule.multistore', 'Attributes are not added.'); ?>
        <?= CHtml::link(Yii::t('MultistoreModule.multistore', 'Add them ?'), ['/multistore/attributeBackend/create']); ?>
    </div>
<?php endif; ?>
