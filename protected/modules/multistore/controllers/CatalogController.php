...
class CatalogController extends \yupe\components\controllers\FrontController
{
    ...
    public function actionShow($name)
    {
        ...
        if (null === $product) {
            throw new CHttpException(404, Yii::t('MultistoreModule.catalog', 'Product was not found!'));
        }
    ...
    {
        $category = MultistoreCategory::model()->findByPath($path);
    ...
    public function actionSearch()
    {
        ...
        if ($form->validate()) {
            ...
            $category = $form->category ? MultistoreCategory::model()->findByPk($form->category) : null;
