...
class TypeBackendController extends yupe\components\controllers\BackController
{
    public function accessRules()
    {
        return [
            ['allow', 'roles' => ['admin'],],
            ['allow', 'actions' => ['index'], 'roles' => ['Multistore.TypeBackend.Index'],],
            ['allow', 'actions' => ['view'], 'roles' => ['Multistore.TypeBackend.View'],],
            ['allow', 'actions' => ['create'], 'roles' => ['Multistore.TypeBackend.Create'],],
            ['allow', 'actions' => ['update'], 'roles' => ['Multistore.TypeBackend.Update'],],
            ['allow', 'actions' => ['delete', 'multiaction'], 'roles' => ['Multistore.TypeBackend.Delete'],],
            ['deny',],
        ];
    }
        ...
        if (($data = Yii::app()->getRequest()->getPost('Type')) !== null) {
            ...
            if ($model->save()) {
                ...
                Yii::app()->user->setFlash(
                    ...
                    Yii::t('MultistoreModule.type', 'Тип товара создан.')
                );
    ...
    public function actionUpdate($id)
    {
        ...
        if (($data = Yii::app()->getRequest()->getPost('Type')) !== null) {
            ...
            if ($model->save()) {
                ...
                Yii::app()->user->setFlash(
                    yupe\widgets\YFlashMessages::SUCCESS_MESSAGE,
                    Yii::t('MultistoreModule.type', 'Тип обновлен.')
                );
    ...
    public function actionDelete($id)
    {
        if (Yii::app()->getRequest()->getIsPostRequest()) {
            ...
            throw new CHttpException(
                400,
                Yii::t('MultistoreModule.type', 'Bad request. Please don\'t use similar requests anymore')
            );
        }
    }
    ...
    public function loadModel($id)
    {
        ...
        if ($model === null) {
            throw new CHttpException(404, Yii::t('MultistoreModule.type', 'Page was not found!'));
        }
        return $model;
    }
