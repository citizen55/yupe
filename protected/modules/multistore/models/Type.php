...
class Type extends \yupe\models\YModel
{
    ...
    public function relations()
    {
        return [
            ...
            'category' => [self::BELONGS_TO, 'MultistoreCategory', 'main_category_id'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'main_category_id' => Yii::t('MultistoreModule.multistore', 'Category'),
            'categories' => Yii::t('MultistoreModule.category', 'Additional categories'),
        ];
    }
