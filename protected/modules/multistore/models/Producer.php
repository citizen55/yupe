...
class Producer extends yupe\models\YModel
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'name_short' => Yii::t('MultistoreModule.multistore', 'Short title'),
            'name' => Yii::t('MultistoreModule.multistore', 'Title'),
            'slug' => Yii::t('MultistoreModule.multistore', 'URL'),
            'status' => Yii::t('MultistoreModule.multistore', 'Status'),
            'order' => Yii::t('MultistoreModule.multistore', 'Order'),
