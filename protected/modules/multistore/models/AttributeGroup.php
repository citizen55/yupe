...
/**
 * This is the model class for table "multistore_attribute_group".
 *
 * @property integer $id
...
class AttributeGroup extends yupe\models\YModel
{
    ...
    {
        return '{{multistore_attribute_group}}';
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'name' => Yii::t('MultistoreModule.attr', 'Group title'),
            'position' => Yii::t('MultistoreModule.attr', 'Position'),
        ];
    }
