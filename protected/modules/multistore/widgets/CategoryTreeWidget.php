...
Yii::import('application.modules.multistore.models.*');
...
class CategoryTreeWidget extends yupe\widgets\YWidget
{
    ...
    public $view = 'multistore.views.widgets.CategoryTreeWidget';

    public function init()
    {
        $moduleAssets = Yii::app()->getModule('multistore')->getAssetsUrl();
    ...
    public function run()
    {
        $data = MultistoreCategory::model()->getMenuList(10);
